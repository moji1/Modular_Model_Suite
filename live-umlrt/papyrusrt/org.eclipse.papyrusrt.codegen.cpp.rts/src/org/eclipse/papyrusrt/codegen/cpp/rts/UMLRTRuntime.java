...
public final class UMLRTRuntime {
	...
	private static final ExternalHeaderFile umlrttcpprotocol_hh = new ExternalHeaderFile("umlrttcpprotocol.hh");
	...
	public static class UMLRTCapsule {
		...
		public static final MemberField currentStateField = new MemberField(UMLRTState.getType().ptr(), "currentState");
		public static final MemberField transitionTableField = new MemberField(UMLRTTransitionTable.getType(), "transitionTable");
		public static final MemberField historyMapField = new MemberField(UMLRTTransitionTable.getType(), "historyMap");
		...
		public static final MemberFunction addStateFunction = new MemberFunction(PrimitiveType.BOOL, "addState");
		public static final MemberFunction addTransitionFunction = new MemberFunction(PrimitiveType.BOOL, "addTransition");
		...
		static {
			...
			addStateFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "name"));
			addTransitionFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "name"));
			addTransitionFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "from"));
			addTransitionFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "to"));
			addTransitionFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "signalName"));
			addTransitionFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "portName"));
		}
		...
		public static ElementAccess currentState() {
			return new ElementAccess(currentStateField);
		}

		public static ElementAccess transitionTable() {
			return new ElementAccess(transitionTableField);
		}

		public static ElementAccess historyMap() {
			return new ElementAccess(historyMapField);
		}
		...
		public static AbstractFunctionCall addState(Expression self, Expression name) {
			MemberFunctionCall call = new MemberFunctionCall(self, addStateFunction);
			call.addArgument(name);
			return call;
		}

		public static AbstractFunctionCall addTransition(Expression self, Expression name, Expression from, Expression to, Expression portName, Expression signalName) {
			MemberFunctionCall call = new MemberFunctionCall(self, addTransitionFunction);
			call.addArgument(name);
			call.addArgument(from);
			call.addArgument(to);
			call.addArgument(portName);
			call.addArgument(signalName);
			return call;
		}
	}

	public static class UMLRTState {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTState", "class UMLRTCapsule::UMLRTState");
		...
		public static final AbstractFunctionCall Ctor(Expression name, Expression entry, Expression exit) {
			AbstractFunctionCall call = new ExternalConstructorCall(Element);
			call.addArgument(name);
			call.addArgument(entry);
			call.addArgument(exit);
			return call;
		}

		public static final MemberField nameField = new MemberField(PrimitiveType.CHAR.ptr().const_(), "name");
	}

	public static class UMLRTTrigger {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTTrigger", "class UMLRTCapsule::UMLRTTrigger");

		public static Type getType() {
			return Element.getType();
		}

		public static final AbstractFunctionCall Ctor(Expression portName, Expression signalName) {
			AbstractFunctionCall call = new ExternalConstructorCall(Element);
			call.addArgument(portName);
			call.addArgument(signalName);
			return call;
	...
	public static class UMLRTAction {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTAction", "struct UMLRTCapsule::UMLRTAction");
	...
	public static class UMLRTGuard {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTGuard", "struct UMLRTCapsule::UMLRTGuard");
	...
	public static class UMLRTChoice {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTChoice", "struct UMLRTCapsule::UMLRTChoice");
	...
	public static class UMLRTTransition {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTTransition", "class UMLRTCapsule::UMLRTTransition");

		public static Type getType() {
			return Element.getType();
		}

		public static final AbstractFunctionCall Ctor(Expression from, Expression to) {
			AbstractFunctionCall call = new ExternalConstructorCall(Element);
			call.addArgument(from);
			call.addArgument(to);
			return call;
		...
		public static final AbstractFunctionCall Ctor(Expression from, Expression to, Expression effect) {
			AbstractFunctionCall call = new ExternalConstructorCall(Element);
			call.addArgument(from);
			call.addArgument(to);
			call.addArgument(StandardLibrary.NULL());
			call.addArgument(effect);
			return call;
		}

		public static final AbstractFunctionCall Ctor(Expression name, Expression from, Expression to, Expression choice, Expression guard, Expression effect) {
			AbstractFunctionCall call = new ExternalConstructorCall(Element);
			call.addArgument(name);
			call.addArgument(from);
			call.addArgument(to);
			call.addArgument(choice);
			call.addArgument(guard);
			call.addArgument(effect);
			return call;
		}
	}

	public static class UMLRTTransitionTable {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTTransitionTable", "class UMLRTCapsule::UMLRTTransitionTable");
		...
		public static final MemberFunction addStateFunction = new MemberFunction(PrimitiveType.BOOL, "addState");
		public static final MemberFunction addTransitionFunction = new MemberFunction(PrimitiveType.BOOL, "addTransition");
		public static final MemberFunction getStateFunction = new MemberFunction(UMLRTState.getType().ptr(), "getState");

		static {
			addStateFunction.add(new Parameter(UMLRTState.getType().ptr(), "state"));
			addTransitionFunction.add(new Parameter(UMLRTState.getType().ptr(), "state"));
			addTransitionFunction.add(new Parameter(UMLRTTrigger.getType().ptr(), "trigger"));
			addTransitionFunction.add(new Parameter(UMLRTTransition.getType().ptr(), "transition"));
			getStateFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "name"));
		}

		public static AbstractFunctionCall addState(Expression self, Expression state) {
			MemberFunctionCall call = new MemberFunctionCall(self, addStateFunction);
			call.addArgument(state);
			return call;
		}

		public static AbstractFunctionCall addTransition(Expression self, Expression state, Expression trigger, Expression transition) {
			MemberFunctionCall call = new MemberFunctionCall(self, addTransitionFunction);
			call.addArgument(state);
			call.addArgument(trigger);
			call.addArgument(transition);
			return call;
		}

		public static AbstractFunctionCall getState(Expression self, Expression name) {
			MemberFunctionCall call = new MemberFunctionCall(self, getStateFunction);
			call.addArgument(name);
			return call;
		}
	}

	public static class UMLRTHistoryMap {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrtcapsule_hh, "UMLRTCapsule::UMLRTHistoryMap", "class UMLRTCapsule::UMLRTHistoryMap");

		public static Type getType() {
			return Element.getType();
		}

		public static final MemberFunction putFunction = new MemberFunction(PrimitiveType.BOOL, "put");
		public static final MemberFunction getFunction = new MemberFunction(PrimitiveType.CHAR.ptr().const_(), "get");

		static {
			putFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "compositState"));
			putFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "subState"));
			getFunction.add(new Parameter(PrimitiveType.CHAR.ptr().const_(), "compositState"));
		}

		public static AbstractFunctionCall put(Expression self, Expression compositeState, Expression subState) {
			MemberFunctionCall call = new MemberFunctionCall(self, putFunction);
			call.addArgument(compositeState);
			call.addArgument(subState);
			return call;
		}

		public static AbstractFunctionCall get(Expression self, Expression compositeState) {
			MemberFunctionCall call = new MemberFunctionCall(self, getFunction);
			call.addArgument(compositeState);
			return call;
		}
	}
	...
	public static class UMLRTTCPProtocol {
		public static final ExternalElement Element = new ExternalFwdDeclarable(umlrttcpprotocol_hh, "UMLRTTCPProtocol", "class UMLRTTCPProtocol");
		public static final ExternalElement BaseRole = new ExternalFwdDeclarable(umlrttcpprotocol_hh, "UMLRTTCPProtocol_baserole", "class UMLRTTCPProtocol_baserole");
		public static final ExternalElement ReceivedSignal = new ExternalElement(umlrttcpprotocol_hh, "signal_received");
		public static final ExternalElement ConnectedSignal = new ExternalElement(umlrttcpprotocol_hh, "signal_connected");
		public static final ExternalElement DisconnectedSignal = new ExternalElement(umlrttcpprotocol_hh, "signal_disconnected");
		public static final ExternalElement ErrorSignal = new ExternalElement(umlrttcpprotocol_hh, "signal_error");
		...
		static {
			ReceivedSignal.setParent(Element);
			ConnectedSignal.setParent(Element);
			DisconnectedSignal.setParent(Element);
			ErrorSignal.setParent(Element);
		}

		public static Expression Signal(Signal signal) {
			if ("received".equals(signal.getName()))
				return new MemberAccess(Element, ReceivedSignal);
			if ("connected".equals(signal.getName()))
				return new MemberAccess(Element, ConnectedSignal);
			if ("disconnected".equals(signal.getName()))
				return new MemberAccess(Element, DisconnectedSignal);
			if ("error".equals(signal.getName()))
				return new MemberAccess(Element, ErrorSignal);
			return null;
		}
	}
	...
	public static Type getSystemProtocolRole(Protocol protocol, boolean baseRole) {
		...
		if (RTSModelLibraryUtils.isTCPProtocol(protocol))
			return baseRole ? UMLRTTCPProtocol.getBaseRoleType() : null;
		return null;
	}
	...
	public static boolean needsUMLRTCommsPort(Protocol protocol) {
		...
		if (RTSModelLibraryUtils.isTCPProtocol(protocol))
			return UMLRTTCPProtocol.needsUMLRTCommsPort();
	...
	public static Expression getSystemProtocolSignalAccess(Signal signal) {
		...
		if (RTSModelLibraryUtils.isTCPProtocol(protocol))
			return UMLRTTCPProtocol.Signal(signal);
		return null;
	}
}
